...
(function () {
  ...
  var CATALOG = [
    ...
    {
      id: "neptunecodeeditor",
      name: "Neptune Code Editor",
      desc: "Full-featured code editor with syntax highlighting, line numbers, themes, find & replace, and tab support.",
      color: "#5c6bc0",
      letter: "< />",
      type: "real",
      appKey: "codeeditor",
      shortcutIcon: "assets/icons/codeeditor.svg",
    },
    {
      id: "neptuneworldclock",
      name: "Neptune World Clock",
      desc: "Track time across 12 timezones with stopwatch and countdown timer.",
      color: "#42a5f5",
      letter: "\u23F0",
      type: "real",
      appKey: "worldclock",
      shortcutIcon: "assets/icons/worldclock.svg",
    },
    {
      id: "neptunediskcleanup",
      name: "Neptune Disk Cleanup",
      desc: "Scan your disk for junk files and free up space.",
      color: "#26a69a",
      letter: "\uD83D\uDDC4",
      type: "real",
      appKey: "diskcleanup",
      shortcutIcon: "assets/icons/diskcleanup.svg",
    },
    {
      id: "neptuneweather",
      name: "Neptune Weather",
      desc: "5-day weather forecast with temperature trends and conditions.",
      color: "#ff7043",
      letter: "\u26C5",
      type: "real",
      appKey: "weatherdash",
      shortcutIcon: "assets/icons/weatherdash.svg",
    },
    {
      id: "neptuneemail",
      name: "Neptune Email",
    ...
    },
    {
      id: "neptunechess",
      name: "Neptune Chess",
      desc: "Play chess against the computer with AI opponent.",
      color: "#8d6e63",
      letter: "\u265F",
      type: "real",
      appKey: "chess",
      shortcutIcon: "assets/icons/chess.svg",
    },
    {
      id: "neptunesudoku",
      name: "Neptune Sudoku",
      desc: "Number puzzle with 3 difficulty levels, timer, and error checking.",
      color: "#5c6bc0",
      letter: "9",
      type: "real",
      appKey: "sudoku",
      shortcutIcon: "assets/icons/sudoku.svg",
    },
    {
      id: "neptunesysinfo",
      name: "Neptune System Info",
      desc: "Neofetch-style system information with live stats and ASCII art.",
      color: "#26a69a",
      letter: "i",
      type: "real",
      appKey: "sysinfo",
      shortcutIcon: "assets/icons/sysinfo.svg",
    },
    {
      id: "neptunedos",
      name: "NeptuneDOS Terminal",
      desc: "Full MS-DOS shell with 70+ commands, themes, aliases, and calculator.",
      color: "#00695c",
      letter: ">",
      type: "real",
      appKey: "neptunedos",
